...
export default function NewItem({ onAddItem }) {
  ...
  return (
    <div className="bg-slate-100 p-8 rounded-xl shadow-md w-full max-w-md mb-8">
      <h2 className="text-2xl font-bold mb-6 text-slate-900">Add New Item</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Min 1, Max 99</p>
        </div>
